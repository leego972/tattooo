    ...
    try {
      const response = await fetch("https://dev.to/api/articles", {
        ...
        headers: {
          ...
          "api-key": SOCIAL_ENV.devtoApiKey,
        },
        body: JSON.stringify({
          article: {
            title: params.title,
  ...
  async getMyArticles(page = 1, perPage = 30): Promise<any[]> {
    ...
    try {
      const response = await fetch(`https://dev.to/api/articles/me?page=${page}&per_page=${perPage}`, {
        headers: { "api-key": SOCIAL_ENV.devtoApiKey },
      });
...
export const mediumAdapter = {
  get isConfigured() {
    return !!(SOCIAL_ENV.mediumAccessToken && SOCIAL_ENV.mediumAuthorId);
  },
  ...
  async publishPost(params: {
    ...
    try {
      const response = await fetch(`https://api.medium.com/v1/users/${SOCIAL_ENV.mediumAuthorId}/posts`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${SOCIAL_ENV.mediumAccessToken}`,
        },
        body: JSON.stringify({
          title: params.title,
...
export const hashnodeAdapter = {
  get isConfigured() {
    return !!(SOCIAL_ENV.hashnodeApiKey && SOCIAL_ENV.hashnodePublicationId);
  },
    ...
    try {
      ...
      const variables = {
        input: {
          ...
          publicationId: SOCIAL_ENV.hashnodePublicationId,
          slug,
      ...
      const response = await fetch("https://gql.hashnode.com", {
        ...
        headers: {
          "Content-Type": "application/json",
          Authorization: SOCIAL_ENV.hashnodeApiKey,
        },
...
export const discordAdapter = {
  get isConfigured() {
    return !!SOCIAL_ENV.discordWebhookUrl;
  },
  ...
  async postMessage(params: {
    ...
    try {
      const response = await fetch(SOCIAL_ENV.discordWebhookUrl, {
        method: "POST",
...
export const mastodonAdapter = {
  get isConfigured() {
    return !!(SOCIAL_ENV.mastodonAccessToken && SOCIAL_ENV.mastodonInstanceUrl);
  },
  ...
  async postStatus(params: {
    ...
    try {
      const instanceUrl = SOCIAL_ENV.mastodonInstanceUrl.replace(/\/$/, "");
      const response = await fetch(`${instanceUrl}/api/v1/statuses`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${SOCIAL_ENV.mastodonAccessToken}`,
        },
        body: JSON.stringify({
...
export const telegramAdapter = {
  get isConfigured() {
    return !!(SOCIAL_ENV.telegramBotToken && SOCIAL_ENV.telegramChannelId);
  },
  ...
  async sendMessage(params: {
    ...
    try {
      const response = await fetch(`https://api.telegram.org/bot${SOCIAL_ENV.telegramBotToken}/sendMessage`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          chat_id: SOCIAL_ENV.telegramChannelId,
          text: params.text,
  ...
  async sendPhoto(params: {
    ...
    try {
      const response = await fetch(`https://api.telegram.org/bot${SOCIAL_ENV.telegramBotToken}/sendPhoto`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          chat_id: SOCIAL_ENV.telegramChannelId,
...
export const whatsappAdapter = {
  get isConfigured() {
    return !!(SOCIAL_ENV.whatsappAccessToken && SOCIAL_ENV.whatsappPhoneNumberId);
  },
  ...
  async sendTemplateMessage(params: {
    ...
    try {
      const response = await fetch(
        `https://graph.facebook.com/v21.0/${SOCIAL_ENV.whatsappPhoneNumberId}/messages`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
            Authorization: `Bearer ${SOCIAL_ENV.whatsappAccessToken}`,
          },
          body: JSON.stringify({
